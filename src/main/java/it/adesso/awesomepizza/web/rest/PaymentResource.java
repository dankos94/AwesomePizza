...
import it.adesso.awesomepizza.service.PaymentService;
...
/**
 * REST controller for managing {@link it.adesso.awesomepizza.domain.Payment}.
 */
@RestController
...
public class PaymentResource {
    ...
    public List<PaymentDTO> getAllPayments(@RequestParam(name = "filter", required = false) String filter) {
        if ("pizzaorder-is-null".equals(filter)) {
            LOG.debug("REST request to get all Payments where pizzaOrder is null");
            return paymentService.findAllWherePizzaOrderIsNull();
        }

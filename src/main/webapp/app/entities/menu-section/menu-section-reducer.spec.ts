...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENUSECTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENUSECTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENUSECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_MENUSECTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_MENUSECTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENUSECTION actions', async () => {
      const arg = 42666;

...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERSTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERSTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ORDERSTATUS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERSTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERSTATUS actions', async () => {
      const arg = 42666;

...
export const PaymentMethodDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="awesomePizzaApp.paymentMethod.delete.question">
        <Translate contentKey="awesomePizzaApp.paymentMethod.delete.question" interpolate={{ id: paymentMethodEntity.id }}>

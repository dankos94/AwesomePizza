  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="awesomePizzaApp.paymentMethod.home.createOrEditLabel" data-cy="PaymentMethodCreateUpdateHeading">
            <Translate contentKey="awesomePizzaApp.paymentMethod.home.createOrEditLabel">Create or edit a PaymentMethod</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('awesomePizzaApp.paymentMethod.methodName')}

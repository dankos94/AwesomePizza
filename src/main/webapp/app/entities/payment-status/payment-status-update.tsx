...
import { createEntity, getEntity, reset, updateEntity } from './payment-status.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="awesomePizzaApp.paymentStatus.home.createOrEditLabel" data-cy="PaymentStatusCreateUpdateHeading">
            <Translate contentKey="awesomePizzaApp.paymentStatus.home.createOrEditLabel">Create or edit a PaymentStatus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('awesomePizzaApp.paymentStatus.statusName')}
                id="payment-status-statusName"
                name="statusName"
                data-cy="statusName"
                type="text"
                validate={{

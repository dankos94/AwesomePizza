...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIZZAMENU_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PIZZAMENU actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PIZZAMENU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PIZZAMENU actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PIZZAMENU actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PIZZAMENU actions', async () => {
      const arg = 42666;

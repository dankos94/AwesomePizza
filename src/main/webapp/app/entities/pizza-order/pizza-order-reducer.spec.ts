...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PIZZAORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PIZZAORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PIZZAORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PIZZAORDER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PIZZAORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PIZZAORDER actions', async () => {
      const arg = 42666;

...
public class DishAsserts {
    ...
    public static void assertDishUpdatableRelationshipsEquals(Dish expected, Dish actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getMenuSection()).as("check menuSection").isEqualTo(actual.getMenuSection()))
            .satisfies(e -> assertThat(e.getPizzaOrders()).as("check pizzaOrders").isEqualTo(actual.getPizzaOrders()));
    }
}

...
class OrderStatusResourceIT {
     ...
     */
    public static OrderStatus createEntity() {
        return new OrderStatus().statusName(DEFAULT_STATUS_NAME);
    }
     ...
     * if they test an entity which requires the current entity.
     */
    public static OrderStatus createUpdatedEntity() {
        return new OrderStatus().statusName(UPDATED_STATUS_NAME);
    }

    @BeforeEach
    public void initTest() {
        orderStatus = createEntity();
    }
    ...
    void checkStatusNameIsRequired() throws Exception {
        ...
        // set the field null
        orderStatus.setStatusName(null);
    ...
    void putExistingOrderStatus() throws Exception {
        ...
        updatedOrderStatus.statusName(UPDATED_STATUS_NAME);
    ...
    void fullUpdateOrderStatusWithPatch() throws Exception {
        ...
        partialUpdatedOrderStatus.statusName(UPDATED_STATUS_NAME);

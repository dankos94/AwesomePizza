...
import static it.adesso.awesomepizza.domain.PaymentAsserts.*;
...
class PaymentResourceIT {
    ...
    public static Payment createEntity() {
        return new Payment().paymentDate(DEFAULT_PAYMENT_DATE).amount(DEFAULT_AMOUNT);
    }
    ...
    public static Payment createUpdatedEntity() {
        return new Payment().paymentDate(UPDATED_PAYMENT_DATE).amount(UPDATED_AMOUNT);
    }
    ...
    void putExistingPayment() throws Exception {
        ...
        updatedPayment.paymentDate(UPDATED_PAYMENT_DATE).amount(UPDATED_AMOUNT);
